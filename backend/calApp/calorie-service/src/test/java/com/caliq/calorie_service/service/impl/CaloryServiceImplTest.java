...
class CaloryServiceImplTest {
    ...
    void testSaveToCaloryLogs_NewLog() {
        ...
        assertEquals(BigDecimal.valueOf(500), saved.getTotalCalory());
        assertEquals(BigDecimal.valueOf(35), saved.getProtein());
        assertEquals(BigDecimal.valueOf(18), saved.getFat());
        assertEquals(BigDecimal.valueOf(55), saved.getCarbohydrates());
    }
    @Test
    void testSaveToCaloryLogs_ExistingLog() {
        ...
        verify(caloryLogsRepository, times(1)).save(captor.capture());
        CaloryLogsEntity saved = captor.getValue();
        assertEquals(BigDecimal.valueOf(1500), saved.getTotalCalory());
        assertEquals(BigDecimal.valueOf(85), saved.getProtein());
    }
    @Test
    ...
    void testGetCalendar_Success() {
        ...
        assertEquals(366, response.calendar().size());
